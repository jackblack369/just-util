...
public class IgniteCacheExample {
    ...
    public static void main(String[] args) {
        ...
        IgniteCache<Integer, String> cache = ignite.cache("willCache");

        cache.put(1, "will cache value");
    ...
    private static void getObjectFromCache(Ignite ignite) {
        ...
        IgniteCache<Integer, Employee> cache = ignite.getOrCreateCache("willCache");
    ...
    private static void getFromCacheWithSQl(Ignite ignite) {
        ...
        IgniteCache<Integer, Employee> cache = ignite.cache("willCache");
